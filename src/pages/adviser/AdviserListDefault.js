        ...
        <Block>
          <div className="nk-tb-list is-separate is-medium mb-3">
            <DataTableHead className="nk-tb-item">
              ...
              <DataTableRow size="md">
                <span className="sub-text">Nivel</span>
              </DataTableRow>
              <DataTableRow size="md">
                <span className="sub-text">Calificacion</span>
              </DataTableRow>
...
export default AdviserListDefaultPage;
