      ...
      <Col md="12">
        <Form className="column align-items-center mt-4">
          ...
          >
            ...
            <div class="form-check mb-2">
              <input type="radio" class="form-check-input" id="radio3" name="question4" value={3}/>
            ...
            <div class="form-check mb-2">
              <label class="form-check-label" for="radio2"></label>
              <input type="radio" class="form-check-input" id="radio2" name="question4" value={5} />
          ...
          >
            ...
            <div class="form-check">
              <input type="radio" class="form-check-input" id="radio3" name="question8" value={3}/>
              Transferir parte a un fondo mas conservador.
              <label class="form-check-label"></label>
            </div>
            <div class="form-check">
              <label class="form-check-label" for="radio2"></label>
              <input type="radio" class="form-check-input" id="radio2" name="question8" value={4} />
            ...
            <div class="form-check">
              <label class="form-check-label" for="radio1"></label>
              <input type="radio" class="form-check-input" id="radio1" name="question8" value={5} />
              No haria nada.
            </div>
          </FormGroup>
        </Form>
