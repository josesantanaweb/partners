...
const MainInformation = ({ setModal, editData }) => {
  ...
  const onFormSubmit = async (submitData) => {
    ...
    try {
      await CustomersServices.editCustomerLegal(editData.id, data);
      setModal({ edit: false }, { add: false });
      ...
      <Col md="3" className="mb-4">
        <FormGroup>
          ...
          <input
            ...
            defaultValue={editData?.companyCategory}
      ...
      <Col md="3" className="mb-4">
        <FormGroup>
          ...
          <input
            ...
            defaultValue={editData?.taxIdentificationNumber}
      ...
      <Col md="3" className="mb-4">
        <FormGroup>
          ...
          <input
            ...
            defaultValue={editData?.descriptionOfAccountInvestments}
